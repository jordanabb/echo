...
GEOGRAPHY_HIERARCHY = {
    ...
    "congressional_district": {"name": "Congressional District", "sublevels": []},
...
INDICATOR_METADATA = {
    ...
    "white_population": {
        ...
        "theme": "Demographics",
        "description": "White population (including White Hispanic) as a percent of total population.",
        "available_years": [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023]
    },
    "asian_population": {
    ...
    "ell_students": {
        "name": "English Language Learners (% Students)",
        "theme": "Demographics",
        "description": "English Language Learner students as a percent of total enrolled students.",
        "available_years": [2015, 2016, 2017, 2018, 2019, 2020, 2021]
    },
    "idea_students": {
        "name": "Students with Disabilities (% Students)",
        "theme": "Demographics",
        "description": "Students receiving services under IDEA as a percent of total enrolled students.",
        "available_years": [2015, 2016, 2017, 2018, 2019, 2020, 2021]
    },
    "asian_students": {
        "name": "Asian (% Students)",
    ...
    "white_students": {
        "name": "White (% Students)",
        "theme": "Demographics",
        "description": "White students (including White Hispanic) as a percent of total enrolled students.",
        "available_years": [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022]
    },
    "total_enrollment": {
    ...
    "median_rent": {
        "name": "Median Monthly Residential Rent ($)",
        "theme": "Community",
        "description": "Median monthly rent for residential units.",
        "available_years": [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023]
    },
    "rent_as_percent_income": {
        "name": "Median Rent as % of Income",
        "theme": "Community",
        "description": "Median gross rent as a percentage of household income.",
        "available_years": [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023]
    },
    "unemployment_rate": {
    ...
    "hs_diploma": {
        "name": "High-School Diploma (% Adults 25+ Yrs)",
        "theme": "Education",
        "description": "Percent of adults aged 25+ with at least a high school diploma.",
        "available_years": [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023]
    },
    "college_degree": {
        "name": "College Degree Attained (% Adults 25+ Yrs)",
        "theme": "Education",
        "description": "Percent of adults aged 25+ with a college degree or higher.",
        "available_years": [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023]
    },
    # --- Health Indicators ---
    ...
    "graduation_rate": {
        ...
        "available_years": [2015, 2016, 2017, 2018, 2019, 2020]
    },
    "student_homelessness": {
        "name": "Student Homelessness (% Students)",
        "theme": "Education",
